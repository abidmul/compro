export default function Timeline() {
  return (
    <>
      <div className=" flex p-2 text-3xl text-slate-950 justify-center bg-teal-700">
        <h1
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div
              ...
              data-aos-offset="0"
            >
              <time className="font-mono italic text-slate-950">2019</time>
          ...
          <li>
            ...
            <div
              ...
              data-aos-offset="0"
            >
              <time className="font-mono italic text-slate-950">2021</time>
              <div className="text-lg font-black text-slate-950">Cuisinart</div>
              <p className="text-slate-950">
                pada tahun 2021 Kitman memperkenalkan Produk Baru yaitu
                Cuisinart dikenal karena memperkenalkan food processor pertama
                di indonesia,
              </p>
            </div>
            <hr />
          ...
          <li>
            ...
            <div
              ...
              data-aos-offset="0"
            >
              <time className="font-mono italic text-slate-950">2024</time>
              <div className="text-lg font-black text-slate-950">
                Ekspansi Keluar Kota
              </div>
              <p className="text-slate-950">
